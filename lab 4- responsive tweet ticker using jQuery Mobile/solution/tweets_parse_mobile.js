...
{
    var tag_ticker=$("#tag_block");             //select the #tag_ticker element from html
	...
	$.ajax({                     //read in JSON file using AJAX
	  ...
	  {   										   //if JSON file is successfully read, process it and invoke the animations inside this function
        ...
        $.each(responseData, function(i, item)       //iterate through each tweet 
		{
		   ...
		   var tags=$("<div class='ui-grid-solo' id='tag'> </div>");
           ...
           $("#tag_block").append(tags);	      //the hashtags appended into the <tag> element is passed into HTML
